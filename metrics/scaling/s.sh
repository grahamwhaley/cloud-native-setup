...
# Override the default busybox image...
input_yaml="${SCRIPT_PATH}/stressng.yaml.in"
input_json="${SCRIPT_PATH}/stressng.json.in"
deployment="stressng"
